...
<?php
	...
	//Add 60 days to current date
	$now = date('Y-m-d');
	$expires60 = strtotime ( '+60 days' , strtotime($now)) ;
	$expires60 = date ( 'Y-m-j' , $expires60 );
	
	//Add 60 days to current date
	$expires30 = strtotime ( '+30 days' , strtotime($now)) ;
	$expires30 = date ( 'Y-m-j' , $expires30 );
	
	// Select the users expiring and count them
	$products = mysql_query("SELECT * FROM products WHERE expireDate BETWEEN '$expires30' AND '$expires60' ORDER BY expireDate ASC");
...
<div class="container">
	...
	<?php include('admin_nav.php'); 
		if(!isset($_SESSION['level'])) {
			...
			echo "<h2>You must be a system admin to view this page</h2><br>";
	...
	<div class="span-24">
        <div align="center">
        	There are <?php echo $exp; ?> users expiring in 60 days.
        </div>
    	<!--<div class="box2">-->
