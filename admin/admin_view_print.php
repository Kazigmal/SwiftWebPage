						...
						<table>
							...
							<tr>
								...
								<td>
                                	<?php
										if($admin_level == 'superadmin') {
											echo "<a href='admin_edit_note.php?id=".$row2['id']."'><div align='center'>".$row2['admin_init']."</div></a>";
                                ...
                                <?php 
									if($admin_level == 'superadmin') {
                                        ...
                                        echo '<a href="admin_delete_note.php?id=' . $row2['id'] . '" onclick="return confirm(\'Confirm Delete\');">Delete</a>';
                                        echo "</div></td>";
									}
								?>
							</tr>
