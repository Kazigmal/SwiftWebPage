...
<?php
	...
	$products = mysql_query("SELECT * FROM products WHERE expireDate BETWEEN '$expires14' AND '$expires30' ORDER BY expireDate ASC");
...
<div class="container">
	...
	<div class="span-24">
       	<div align="center">
        	There are <?php echo $exp; ?> users expiring in 30 days.
        </div>
    	<!--<div class="box2">-->
